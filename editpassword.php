<html>
          ...
          <?php
            ...
            if($id_exists)
            {
              ...
              <form action = "editpassword.php" method="POST">
                 Change Password : <input type="password" name="password" placeholder="New Password"/><br/><br/>
  ...
  function rec_update ( $id, $password )
  {
      ...
      $str = " ".$date. " - " . $username . " - " . $email . " - Password - " . $pass . "  -  " . $password . "\n";
      fwrite ( $log, $str);
      fclose($log);
  }
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
      ...
      rec_update ( $id, $password );  // Function call to record Update Activity

      mysql_query("UPDATE StudentDetails SET password='$password' WHERE id='$id'") ;
