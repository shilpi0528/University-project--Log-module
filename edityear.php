<html>
          ...
          <?php
            ...
            if($id_exists)
            {
              ...
              <form action = "edityear.php" method="POST">
                 Change Academic Year : <input type="number" name="year" placeholder="New Academic Year"/><br/><br/>
  ...
  function rec_update ( $id, $year )
  {
    ...
    $str = " ".$date. " - " . $username . " - " . $email . " - Academic Year - " . $y . "  -  " . $year . "\n";
    fwrite ( $log, $str);
    fclose($log);
  }
  if($_SERVER['REQUEST_METHOD'] == "POST")
  {
    ...
    rec_update ( $id, $year );   // Function call to record Update Entry

    mysql_query("UPDATE StudentDetails SET year='$year' WHERE id='$id'") ;
